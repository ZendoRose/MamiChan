...
lRS = mek.message.listResponseMessage.singleSelectReply.selectedRowId
if (lRS.includes(`gruposMenuInky`)){
...
if (mek.message.listResponseMessage){
lRS = mek.message.listResponseMessage.singleSelectReply.selectedRowId
if (lRS.includes(`stickerMenuInky`)){
if (!isUser) return reply(mess.only.reg)
reply(`𝗦𝘁𝗶𝗰𝗸𝗲𝗿 𝗠𝗲𝗻𝘂
...
var rows = [
 {title: 'Menu Grupos', rowId:"gruposMenuInky"},
 {title: 'Menu Sticker', rowId:"stickerMenuInky"}
]
var sections = [{title: `${botName} Menu`, rows: rows}]
var button = {
 buttonText: '𝐂𝐥𝐢𝐜𝐤 𝐀𝐪𝐮𝐢❗',
 description: `
𝐁𝐢𝐞𝐧𝐯𝐞𝐧𝐢𝐝𝐨 𝐚𝐥 𝐦𝐞𝐧𝐮 𝐝𝐞 *${botName}*
...
➼ 𝐒𝐢𝐬𝐭𝐞𝐦𝐚: *${inky.user.phone.divice_manufacturer}*
...
inky.sendMessage(from, button, MessageType.listMessage, {quoted: fakeStatus})
